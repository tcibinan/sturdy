...
from .views import \
    ...
    TaskDetailsView, CreateTaskView, UpdateTaskView, DeleteTaskView
...
urlpatterns = [
    ...
    url(r'^project/(?P<project_id>[0-9]+)/task/(?P<task_id>[0-9]+)/delete$', DeleteTaskView.as_view(), name='task_delete'),
